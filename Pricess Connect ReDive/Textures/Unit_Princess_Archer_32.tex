...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/Pricess Connect ReDive\Textures\Unit_Princess_Archer_32.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>1326220414</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="Unit_Princess_Archer_32.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="Unit_Princess_Archer_32"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
