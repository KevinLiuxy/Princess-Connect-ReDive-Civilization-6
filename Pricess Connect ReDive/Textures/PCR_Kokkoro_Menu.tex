...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/Pricess Connect ReDive\Textures\PCR_Kokkoro_Menu.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>2812383743</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="PCR_Kokkoro_Menu.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="PCR_Kokkoro_Menu"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
