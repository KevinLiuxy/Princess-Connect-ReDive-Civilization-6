...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/Pricess Connect ReDive\Textures\Moment_Guild_Clan.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>1129937647</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="Moment_Guild_Clan.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="Moment_Guild_Clan"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
