...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/Pricess Connect ReDive\Textures\Background_Loading.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>1068618999</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="REDIVE_LOADING_BACKGROUND.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="REDIVE_LOADING_BACKGROUND"/>
	<m_Description text=""/>
	<m_Tags>
