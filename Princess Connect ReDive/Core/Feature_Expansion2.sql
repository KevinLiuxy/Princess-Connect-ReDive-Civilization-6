...
VALUES	('NAMED_DESSERT_PCR1',	'KIND_NAMED_DESERT'	),
		('NAMED_DESSERT_PCR2',	'KIND_NAMED_DESERT'	),
		('NAMED_LAKE_PCR1',		'KIND_NAMED_LAKE'	),
		('NAMED_LAKE_PCR2',		'KIND_NAMED_LAKE'	),
		('NAMED_LAKE_PCR3',		'KIND_NAMED_LAKE'	),
		('NAMED_LAKE_PCR4',		'KIND_NAMED_LAKE'	),
		('NAMED_LAKE_PCR5',		'KIND_NAMED_LAKE'	),
		('NAMED_MOUNTAIN_PCR1',	'KIND_NAMED_MOUNTAIN'),
		('NAMED_MOUNTAIN_PCR2',	'KIND_NAMED_MOUNTAIN'),
		('NAMED_MOUNTAIN_PCR3',	'KIND_NAMED_MOUNTAIN'),
		('NAMED_MOUNTAIN_PCR4',	'KIND_NAMED_MOUNTAIN'),
		('NAMED_MOUNTAIN_PCR5',	'KIND_NAMED_MOUNTAIN'),
		('NAMED_MOUNTAIN_PCR6',	'KIND_NAMED_MOUNTAIN'),
		('NAMED_MOUNTAIN_PCR7',	'KIND_NAMED_MOUNTAIN'),
		('NAMED_OCEAN_PCR1',	'KIND_NAMED_OCEAN'	),
		('NAMED_RIVER_PCR1',	'KIND_NAMED_RIVER'	),
		('NAMED_RIVER_PCR2',	'KIND_NAMED_RIVER'	),
		('NAMED_RIVER_PCR3',	'KIND_NAMED_RIVER'	),
		('NAMED_RIVER_PCR4',	'KIND_NAMED_RIVER'	),
		('NAMED_RIVER_PCR5',	'KIND_NAMED_RIVER'	),
		('NAMED_SEA_PCR1',		'KIND_NAMED_SEA'	),
		('NAMED_SEA_PCR2',		'KIND_NAMED_SEA'	),
		('NAMED_SEA_PCR3',		'KIND_NAMED_SEA'	),
		('NAMED_VOLCANO_PCR1',	'KIND_NAMED_VOLCANO'),
		('NAMED_VOLCANO_PCR2',	'KIND_NAMED_VOLCANO'),
		('NAMED_VOLCANO_PCR3',	'KIND_NAMED_VOLCANO'),
		('NAMED_VOLCANO_PCR4',	'KIND_NAMED_VOLCANO');
