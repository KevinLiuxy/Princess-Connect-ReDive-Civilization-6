...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/Princess Connect Yui\Textures\TEXTURE_PCR_YUI_EXP.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>1152653595</m_ExportedTime>
	<m_ClassName text="Leader_BaseColor"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="TEXTURE_PCR_YUI_EXP.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="TEXTURE_PCR_YUI_EXP"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
