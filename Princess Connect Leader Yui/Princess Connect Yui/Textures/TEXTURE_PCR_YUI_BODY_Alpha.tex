...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/Princess Connect Yui\Textures\TEXTURE_PCR_YUI_BODY_Alpha.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>4171049717</m_ExportedTime>
	<m_ClassName text="Leader_OPAC"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="TEXTURE_PCR_YUI_BODY_Alpha.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="TEXTURE_PCR_YUI_BODY_Alpha"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
