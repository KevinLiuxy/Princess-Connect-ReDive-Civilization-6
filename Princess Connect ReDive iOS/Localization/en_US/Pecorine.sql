...
VALUES
	('en_US',	'LOC_AGENDA_PCR_PECORINE_NAME',
		'Eustiana von Astraea'
	),
	('en_US',	'LOC_AGENDA_PCR_PECORINE_DESCRIPTION',
		'Likes to make friends, dislike civilizations who attack her friends.'
	),
	('en_US',	'LOC_DIPLO_MODIFIER_PECORINE_DECLARED_FRIEND',
		'Pecorine likes to be friend with you'
	),
	('en_US',	'LOC_DIPLO_MODIFIER_PECORINE_DENOUNCED_FRIEND',
		'Pecorine dislikes you denouncing her friends'
	),/* Pecol Scene 7 */
	('en_US',	'LOC_DIPLO_KUDO_EXIT_LEADER_PCR_PECORINE_ANY',
		"To have a place to call home, and people who I can think of like family, who I can share meals with like this...[NEWLINE]Share these kinds of connections with people... I'm really grateful for it."
	),/* Pecol Scene 7 */
	('en_US',	'LOC_DIPLO_WARNING_EXIT_LEADER_PCR_PECORINE_ANY',
	...
	('en_US',	'LOC_DIPLO_DECLARE_FRIEND_FROM_AI_LEADER_PCR_PECORINE_ANY',
		"It's like we're birds of a feather -- we've got perfect compatibility![NEWLINE]So if we can, let's try to be friends for a long time, okay?"
	),/* Pecol Scene 1 */
	('en_US',	'LOC_DIPLO_ACCEPT_DECLARE_FRIEND_FROM_AI_LEADER_PCR_PECORINE_ANY',
		"I'll never forget that kindness! Thank you so much, I love you!"
	),/* Pecol Scene 1 */
	('en_US',	'LOC_DIPLO_REJECT_DECLARE_FRIEND_FROM_AI_LEADER_PCR_PECORINE_ANY',
	...
	('en_US',	'LOC_DIPLO_DENOUNCE_FROM_HUMAN_LEADER_PCR_PECORINE_ANY',
	...
	('en_US',	'LOC_DIPLO_DECLARE_WAR_FROM_AI_LEADER_PCR_PECORINE_ANY',
	...
	('en_US',	'LOC_DIPLO_MAKE_PEACE_FROM_AI_LEADER_PCR_PECORINE_ANY',
		"Ah... Can we put out conflicts aside for now, and break breads again to fill our stomachs?"
	),
	('en_US',	'LOC_DIPLO_DEFEAT_FROM_AI_LEADER_PCR_PECORINE_ANY',
	...
	('en_US',	'LOC_DIPLO_WARNING_DONT_SETTLE_NEAR_ME_AI_LEADER_PCR_PECORINE_ANY',
		"Oh? Why are you settling near me? You're a lonely one, aren't you?[NEWLINE]Please try not to settle this close to me next time, okay?"
	),/* Pecol Scene 1 */
	('en_US',	'LOC_DIPLO_WARNING_DONT_SETTLE_NEAR_ME_AI_RESPONSE_POSITIVE_LEADER_PCR_PECORINE_ANY',
		"That really is the height of rudeness, isn't it? Sorry!"
	),/* Pecol Scene 2 */
	('en_US',	'LOC_DIPLO_WARNING_DONT_SETTLE_NEAR_ME_AI_RESPONSE_NEGATIVE_LEADER_PCR_PECORINE_ANY',
		"Aah, don't make a face like that! It's okay![NEWLINE]We're only here looking for culinary ingredients..."
	),/* Pecol Scene 3 */
	('en_US',	'LOC_DIPLO_WARNING_DONT_SETTLE_NEAR_ME_HUMAN_RESPONSE_POSITIVE_LEADER_PCR_PECORINE_ANY',
		"Yay! What a nice guy! Is it okay if I fall in love with you?"
	),/* Pecol Scene 4 */
	('en_US',	'LOC_DIPLO_WARNING_DONT_SETTLE_NEAR_ME_HUMAN_RESPONSE_NEGATIVE_LEADER_PCR_PECORINE_ANY',
		"Eh... You can't understand what I'm saying?[NEWLINE]You're asking what language I'm speaking?"
	),
	('en_US',	'LOC_DIPLO_WARNING_STOP_SPYING_ON_ME_AI_RESPONSE_POSITIVE_LEADER_PCR_PECORINE_ANY',
		"Sorry! I'll not peek into what you make for dinner again."
	);